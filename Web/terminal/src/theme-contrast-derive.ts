...
const BLOCK_SURFACES: Array<{ block: string; stack: string[]; why: string }> = [
  ...
  { block: "push", stack: ["var(--ui-bg)"], why: "under the head, on the body" },
  { block: "push-switch", stack: ["var(--ui-bg)"], why: "in .push, on the body; it paints --ui-accent-soft itself when checked" },
  ...
  { block: "quota", stack: ["var(--ui-bg)"], why: "above the cards, on the body" },
  { block: "quota-bars", stack: ["var(--ui-bg)"], why: "in .quota, on the body" },
  { block: "quota-bar", stack: ["var(--ui-bg)"], why: "in .quota, on the body" },
  ...
  { block: "quota-fill", stack: ["var(--ui-bg)"], why: "in .quota-cells, on the body" },
  ...
  { block: "quota-note", stack: ["var(--ui-bg)"], why: "in .quota, on the body" },
  { block: "usage", stack: ["var(--ui-bg)"], why: "above the quota, on the body" },
  { block: "usage-head", stack: ["var(--ui-bg)"], why: "in .usage, on the body" },
  { block: "usage-title", stack: ["var(--ui-bg)"], why: "in .usage-head, on the body" },
  { block: "usage-toggles", stack: ["var(--ui-bg)"], why: "in .usage-head, on the body" },
  { block: "usage-toggle", stack: ["var(--ui-bg)"], why: "in .usage-toggles, on the body" },
  { block: "usage-headline", stack: ["var(--ui-bg)"], why: "in .usage, on the body" },
  { block: "usage-amount", stack: ["var(--ui-bg)"], why: "in .usage-headline, on the body" },
  { block: "usage-qualifier", stack: ["var(--ui-bg)"], why: "in .usage-headline, on the body" },
  { block: "usage-chart", stack: ["var(--ui-bg)"], why: "in .usage, on the body; its bars are currentColor" },
  { block: "usage-axis", stack: ["var(--ui-bg)"], why: "in .usage, on the body" },
  ...
  // --- sessions.css: the panels between the meters and the tree, on the body ---
  { block: "panel", stack: ["var(--ui-bg)"], why: "under the quota, on the body; it paints nothing" },
  { block: "panel-label", stack: ["var(--ui-bg)"], why: "in .panel, on the body" },
  { block: "panel-body", stack: ["var(--ui-bg)"], why: "in .panel, on the body" },
  { block: "panel-fold", stack: ["var(--ui-bg)"], why: "an .archived fold in .panel, on the body; it paints nothing" },
  ...
  { block: "yield-tile", stack: ["var(--ui-bg)"], why: "in .yield, on the body; its left edge is a hairline" },
