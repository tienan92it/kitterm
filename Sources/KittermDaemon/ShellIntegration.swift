/// The zsh shell-integration snippet, embedded so `kitterm integrate` can
/// print it from any install — including piped over ssh into a VM or
/// container whose shell does not emit OSC 133 natively.
///
/// `scripts/shell-integration.zsh` is the canonical copy; a test asserts the
/// two never drift.
