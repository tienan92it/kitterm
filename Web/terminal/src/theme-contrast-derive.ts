...
const BLOCK_SURFACES: Array<{ block: string; stack: string[]; why: string }> = [
  ...
  { block: "band-cells", stack: ["var(--ui-bg)"], why: "in .band, on the body" },
  { block: "band-cell", stack: ["var(--ui-bg)"], why: "in .band-cells, on the body" },
  ...
  // --- sessions.css: the panels, on the body ---
  { block: "panel", stack: ["var(--ui-bg)"], why: "under the band, on the body; it paints nothing" },
  { block: "panel-label", stack: ["var(--ui-bg)"], why: "in .panel, on the body" },
  { block: "panel-body", stack: ["var(--ui-bg)"], why: "in .panel, on the body" },
  ...
  { block: "panel-toggle", stack: ["var(--ui-bg)"], why: "in .panel-head, on the body" },
  { block: "usage-head", stack: ["var(--ui-bg)"], why: "in .panel-body, on the body" },
  { block: "usage-amount", stack: ["var(--ui-bg)"], why: "in .usage-head, on the body" },
  { block: "usage-fact", stack: ["var(--ui-bg)"], why: "in .usage-head, on the body" },
  { block: "usage-span", stack: ["var(--ui-bg)"], why: "in .usage-head, on the body" },
  { block: "usage-toggle-groups", stack: ["var(--ui-bg)"], why: "in .usage-head, on the body" },
  { block: "usage-toggles", stack: ["var(--ui-bg)"], why: "in .usage-head or .panel-head, on the body" },
  { block: "usage-toggle", stack: ["var(--ui-bg)"], why: "in .usage-toggles, on the body" },
  { block: "usage-chart", stack: ["var(--ui-bg)"], why: "in .panel-body, on the body; its bars are marks in the accent" },
  { block: "usage-axis", stack: ["var(--ui-bg)"], why: "in .panel-body, on the body" },
  { block: "usage-peak", stack: ["var(--ui-bg)"], why: "in .usage-axis, on the body" },
  { block: "usage-note", stack: ["var(--ui-bg)"], why: "in .panel-body, on the body" },
  { block: "quota-bars", stack: ["var(--ui-bg)"], why: "in .panel-body, on the body" },
  ...
  { block: "yield-noun", stack: ["var(--ui-bg)"], why: "in .yield-tile, on the body" },
  { block: "yield-noun-short", stack: ["var(--ui-bg)"], why: "in .yield-tile, on the body" },
  { block: "yield-rate", stack: ["var(--ui-bg)"], why: "in .yield-tile, on the body" },
  { block: "split", stack: ["var(--ui-bg)"], why: "in .panel-body, on the body" },
  { block: "split-row", stack: ["var(--ui-bg)"], why: "in .split, on the body" },
  { block: "split-name", stack: ["var(--ui-bg)"], why: "in .split-row, on the body" },
  { block: "split-bar", stack: ["var(--ui-bg)"], why: "in .split-row, on the body; holds the bar mark, no text" },
  { block: "split-spend", stack: ["var(--ui-bg)"], why: "in .split-row, on the body" },
  { block: "split-short", stack: ["var(--ui-bg)"], why: "in .split-row, on the body" },
  { block: "split-count", stack: ["var(--ui-bg)"], why: "in .split-row, on the body" },
  { block: "split-units", stack: ["var(--ui-bg)"], why: "in .split-row, on the body" },
  { block: "split-rate", stack: ["var(--ui-bg)"], why: "in .split-row, on the body" },
  ...
  { block: "tree-keys", stack: ["var(--ui-bg)"], why: "in .tree-head, on the body" },
  { block: "tree-key", stack: ["var(--ui-bg)"], why: "in .tree-keys, on the body" },
  { block: "tree", stack: ["var(--ui-bg)"], why: "the tree, on the body; no card, no surface" },
  { block: "tree-section", stack: ["var(--ui-bg)"], why: "in .tree, on the body" },
  { block: "line", stack: ["var(--ui-bg)"], why: "a line of the tree, on the body" },
  { block: "line-name", stack: ["var(--ui-bg)"], why: "in a line, on the body" },
  { block: "main", stack: ["var(--ui-bg)"], why: "in a line, on the body" },
  { block: "state", stack: ["var(--ui-bg)"], why: "in .main, on the body" },
  { block: "cost", stack: ["var(--ui-bg)"], why: "a fact in .main, on the body" },
  { block: "counter", stack: ["var(--ui-bg)"], why: "a fact in .main, on the body" },
  { block: "round", stack: ["var(--ui-bg)"], why: "a fact in .main, on the body" },
  { block: "pr", stack: ["var(--ui-bg)"], why: "a fact in .main, on the body" },
  ...
  { block: "goal-line", stack: ["var(--ui-bg)"], why: "a goal's line, on the body" },
  { block: "line-task", stack: ["var(--ui-bg)"], why: "a task's line, on the body" },
  { block: "row", stack: ["var(--ui-bg)"], why: "a session and its approvals, on the body" },
  { block: "row-line", stack: ["var(--ui-bg)"], why: "the line of a row, on the body" },
  { block: "open", stack: ["var(--ui-bg)"], why: "the row's link, on the body" },
  { block: "folder", stack: ["var(--ui-bg)"], why: "the row's name, on the body" },
  { block: "line-approval", stack: ["var(--ui-bg)"], why: "an approval's line, on the body" },
  ...
  { block: "folds", stack: ["var(--ui-bg)"], why: "the page's foot, on the body" },
  { block: "archived-list", stack: ["var(--ui-bg)"], why: "in the archive fold, on the body" },
  { block: "archived-name", stack: ["var(--ui-bg)"], why: "in the archive fold, on the body" },
  { block: "archived-meta", stack: ["var(--ui-bg)"], why: "in the archive fold, on the body" },
  { block: "push", stack: ["var(--ui-bg)"], why: "in .folds, on the body" },
  { block: "push-switch", stack: ["var(--ui-bg)"], why: "in .push, on the body" },
  { block: "push-state", stack: ["@push-switch"], why: "in .push-switch, whichever state it wears" },
  { block: "push-detail", stack: ["var(--ui-bg)"], why: "in .push, on the body" },
